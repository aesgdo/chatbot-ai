...
function chatbot_ai_charge_front_end_scripts() {   
    ...
    wp_enqueue_style('chatbot-ai-font-awesome-cdn', 'https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.1/css/all.min.css');
    ...
    wp_enqueue_script('chatbot-ai-routes-scripts', plugin_dir_url(__FILE__) . '../../assets/js/routes.js', array('jquery'), null, true);
